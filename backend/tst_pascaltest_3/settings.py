"""
Django settings for tst_pascaltest_3 project.
...
ROOT_URLCONF = 'tst_pascaltest_3.urls'
...
WSGI_APPLICATION = 'tst_pascaltest_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_pascaltest_3 API",
    "DESCRIPTION": "API documentation for tst_pascaltest_3 App",
    "VERSION": "v1",
}
